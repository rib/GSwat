 ...
 *
 * $Id: gedit-document-loader.c,v 1.5.2.2 2006/04/20 17:05:25 pborelli Exp $
 */
...
load_completed_or_failed (GeditDocumentLoader *loader)
{
	...
	if (loader->priv->error == NULL)
		//RIB gedit_debug_message (DEBUG_LOADER, "load completed");
	else
		//RIB gedit_debug_message (DEBUG_LOADER, "load failed");
#endif
...
load_local_file_real (GeditDocumentLoader *loader)
{
	...
	else
	{
		...
		{
			//RIB gedit_debug_message (DEBUG_SAVER, "mmap failed");
