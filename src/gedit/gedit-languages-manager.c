 ...
 *
 * $Id: gedit-languages-manager.c,v 1.10 2006/03/04 17:21:57 paolo Exp $
 */
...
tag_style_to_string (const GtkSourceTagStyle *style)
{
	...
	background = gdk_color_to_string_compat (style->background);
	foreground = gdk_color_to_string_compat (style->foreground);
